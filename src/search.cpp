...
namespace LogSearch
{
    ...
    void Search::begin()
    {
        ...
        // qDebug() << "Search::begin: thread:" << QThread::currentThread() << "isMainThread:" << QThread::
                                                 ...
                                                 SearchCompleteSignal onComplete)
    {
        ...
        else
        {
            ...
            connect(search.data(), &Search::progress, this,
                    static_cast<void(SearchManager::*)(const int, const QSharedPointer<Search>)>(&
                        SearchManager::onSearchProgress), Qt::QueuedConnection);
        }
        ...
        else
        {
            ...
            connect(search.data(), &Search::canceled, this,
                    static_cast<void(SearchManager::*)(const QSharedPointer<Search>)>(&SearchManager::onSearchCanceled),
                    Qt::QueuedConnection);
            connect(search.data(), &Search::finished, this,
                    static_cast<void(SearchManager::*)(const QSharedPointer<Search>)>(&SearchManager::onSearchFinished),
                    Qt::QueuedConnection);
        }
